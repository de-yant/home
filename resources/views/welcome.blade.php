...
<body>
    <div style="background-image: url('{{ asset('asset/image/bg-3.jpg') }}'); background-size: cover; background-position: center;"
        ...
        <div class="flex flex-col items-center justify-center w-full lg:max-w-4xl max-w-[800px]">
            <div class="w-full lg:max-w-4xl max-w-[335px] text-center">
                <div class="bg-white/80 p-2 rounded-full w-fit mx-auto mb-6">
                    <img src="{{ asset('asset/image/logo.png') }}" alt="Logo"
                        class="w-24 h-24 lg:w-64 lg:h-32 object-contain rounded-full" />
                </div>


                <div class="bg-white/70 dark:bg-black/70 p-6 lg:p-8 rounded-xl text-center shadow-lg backdrop-blur-md">
                    <h1 class="text-4xl lg:text-5xl font-bold mb-4 text-[#1b1b18] dark:text-[#EDEDEC] drop-shadow-md">
                        Welcome to {{ config('app.name', 'HomeDev') }}
                    </h1>
                    <p class="text-lg mb-6 text-[#1b1b18] dark:text-[#EDEDEC] drop-shadow-sm">
                        Easily track the progress of your home development on this page.
                    </p>

                    <form action="{{ url('/search') }}" method="GET" class="mb-6">
                        <input type="text" id="searchInput" name="query" placeholder=""
                            class="w-full lg:w-1/2 px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                        <button type="submit"
                            class="mt-2 inline-block px-6 py-2 rounded-md text-sm font-medium bg-gradient-to-r from-green-600 to-green-700 text-white hover:from-green-700 hover:to-green-800 focus:outline-none focus:ring-2 focus:ring-green-500 dark:from-green-500 dark:to-green-600 dark:hover:from-green-600 dark:hover:to-green-700 transition-all duration-300 shadow-md">
                            Search
                        </button>
                    </form>
                    ...
                    <script>
                        ...
                        const text = "Search for house progress...";
                        let i = 0;
                        ...
                        function typeLoop() {
                            ...
                            if (!isDeleting) {
                                ...
                                if (i === text.length) {
                                    isDeleting = true;
                                    setTimeout(typeLoop, 20); // wait before deleting
                                    return;
                                }
                            } else {
                                input.setAttribute("placeholder", text.substring(0, i - 1));
