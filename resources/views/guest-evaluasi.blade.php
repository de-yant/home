    ...
    <div class="flex flex-col items-center justify-center w-full px-4">
        <div class="w-full max-w-4xl text-center">
            <div class="bg-white/70 dark:bg-black/70 p-6 lg:p-8 rounded-xl text-center shadow-lg backdrop-blur-md">
                <div class="max-w-6xl mx-auto p-6">
                    ...
                    <div class="max-w-lg mx-auto bg-white dark:bg-gray-800 p-6 rounded shadow">
                        <h2 class="text-xl font-bold mb-4 text-gray-800 dark:text-white">Form Evaluasi untuk Unit:
                            {{ $unit }}</h2>
            ...
            {{ session('success') ? 'bg-green-100 text-green-800 border-green-200' : 'bg-red-100 text-red-800 border-red-200' }}">
                        ...
                        <form action="{{ route('guest.evaluasi.store') }}" method="POST"
                            enctype="multipart/form-data" class="space-y-4">
                            @csrf
                            <input type="hidden" name="id_unit" value="{{ $unit }}">
                            <input type="hidden" name="id_progres" value="{{ $progress->id_progres }}">

                            {{-- Grid untuk Status & Foto --}}
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                ...
                                <div>
                                    <label for="foto"
                                        class="block font-medium text-sm text-gray-700 dark:text-gray-300">Lampirkan
                                        Foto</label>
                            ...
                            <div class="mb-4">
                                <label for="catatan"
                                    class="block font-medium text-sm text-gray-700 dark:text-gray-300">Catatan</label>
                                <textarea name="catatan" id="catatan" rows="3" class="w-full mt-1 px-3 py-2 border rounded resize-none"></textarea>
                            </div>
